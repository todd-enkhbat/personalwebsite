...
export const meetInvite = {
  ...
  body: "Conversation, coffee, a walk -- say hello if you're nearby.",
  window: "Especially free in New York Aug 2-8, before I head west.",
  cta: "Let's grab coffee",
  ctaHref: "https://calendar.app.google/9MztKG4bvzgpMp6HA"
};
...
export const linkedReferences: LinkItem[] = [
  { label: "Columbia University", href: "https://college.columbia.edu", external: true },
  {
...
export const work: WorkItem[] = [
  ...
  },
  {
    id: "piano",
    title: "Concert Piano",
    role: "Solo Performer | Concert Pianist",
    place: "Benasque, Aragon, Spain",
    dates: "Jan 2016 - Dec 2018",
    blurb: "International competitions and stages from Spain to Windsor and Moscow",
    summary:
      "Eleven years at the instrument under pianist Saya Sangidorj (Saya Piano School / C.E.M. Tchaikovsky Huesca). Professional invitations from Carnegie Hall and the Mongolian Musical Conservatory; stages including the Queen’s palace, Windsor Castle, and the Mongolian Philharmonic; Grand Prix, gold, and silver across France, Spain, Italy, England, South Korea, and Russia.",
    achievements: [
      "Professional invitations from Carnegie Hall and the Mongolian Musical Conservatory",
      "Performed at the Queen’s palace, Windsor Castle, and the Mongolian Philharmonic",
      "Grand Prix, gold, and silver medals in competitions across six countries",
      "Stages in Paris, Lyon, Madrid, Barcelona, Rome, London, Windsor, Moscow, and more"
    ],
    tags: ["Piano", "Concert", "Competitions", "Saya Sangidorj"],
    href: "/work/piano"
  },
  {
    id: "hur",
...
export const portfolioRows: PortfolioRow[] = [
    ...
    cards: [
      {
        ...
        href: "/work/cfa",
        logos: [
          { src: "/paper-assets/orgs/harvard-logo.svg", alt: "Harvard University" },
          { src: "/paper-assets/orgs/cfa-logo.png", alt: "Center for Astrophysics | Harvard & Smithsonian" }
        ]
      }
    ]
  },
  ...
  },
  {
    ...
    cards: [
      {
        id: "piano",
        title: "Concert Piano Journey",
        role: "Solo Performer · Concert Pianist",
        label: "Piano",
        description:
          "Saya Piano School / C.E.M. Tchaikovsky: Carnegie Hall and Mongolian Conservatory invitations; Windsor Castle; medals across Europe and Asia.",
        image: "/paper-assets/piano-hero.png",
...
export const publications: PublicationPiece[] = [
  ...
  },
  {
    ...
    figures: [
      {
        image: "/paper-assets/marsv-hero.png",
        kicker: "Figure · Program",
        caption: "MARS-V visual language for the public lecture."
      }
    ],
    featureLayout: "inset"
  },
    ...
    figures: [
      {
        ...
        caption: "Program still from the MARS-V documentary world."
      }
    ],
    featureLayout: "inset"
  }
...
export const calendarLanes: CalendarLane[] = [
  {
    ...
    dates: "Aug 2-8",
    title: "New York",
    note: "Around Columbia, coffee welcome.",
    tone: "solid",
    open: true
  },
  {
  ...
  },
  {
    label: "After",
    dates: "Aug 26 - Sep 1",
    title: "Seattle · Redmond",
    note: "Washington area stretch.",
    tone: "dashed",
    open: true
  },
  {
    ...
    dates: "Sep 23-24",
    title: "Houston",
    note: "Payload Off World · Space Center Houston",
    tone: "event",
    open: true,
    org: "Payload",
...
export const calendarPhotos: { src: string; alt: string; wide?: boolean }[] = [
  { src: "/paper-assets/calendar/nypl.jpg", alt: "New York Public Library at night" },
  { src: "/paper-assets/calendar/russian-tea-room.jpg", alt: "Russian Tea Room awning on a rainy street" },
  { src: "/paper-assets/calendar/world-leaders-forum.jpg", alt: "Columbia University World Leaders Forum", wide: true },
  { src: "/paper-assets/calendar/fayerweather.jpg", alt: "Fayerweather Hall at Columbia in evening light" },
  { src: "/paper-assets/calendar/subway-sign.jpg", alt: "Downtown and Brooklyn subway sign", wide: true },
  { src: "/paper-assets/calendar/bridge.jpg", alt: "Stone bridge tower against blue sky", wide: true },
  { src: "/paper-assets/calendar-visual.jpg", alt: "Calendar visual", wide: true },
  { src: "/paper-assets/calendar/utopia.jpg", alt: "UTOPIA on a screen", wide: true }
];
...
export const trainings = [
  {
    ...
    body: "Western classical thought at Columbia's Philosophy department, following the example of David Albert and the philosophical foundations of physics. Outside the syllabus, I study Buddhist philosophy with Tibetan teachers in the Nalanda lineage. Borges is the writer I keep returning to, and the work keeps circling the same three things: time, the universe, and thermodynamics.",
  ...
  },
  {
    ...
    body: "Professor Brian Greene put an eye of Horus in my hand in my first year, and Origins and Meaning did the rest: Russell, Tolstoy, and Ernest Becker read alongside cosmology. Since then, research in astrophysics, spacesuits, mission design, and black holes, collected in the portfolio. What I want now is to build the instruments these questions require.",
